...
neuraloperator_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), "../")
...
def wandb_login(api_key_file= os.path.join(neuraloperator_dir,'config/wandb_api_key.txt'), key=None):
    if key is None:
...
def set_wandb_api_key(api_key_file=os.path.join(neuraloperator_dir,'config/wandb_api_key.txt')):
    import os
...
def get_wandb_api_key(api_key_file=os.path.join(neuraloperator_dir,'config/wandb_api_key.txt')):
    import os
